...
-(void)getGoogleObjects:(CLLocationCoordinate2D)coords andTypes:(NSString *)types andRadius:(CLLocationDistance)dist
{	
    ...
    NSString* gurl  = [NSString stringWithFormat:@"https://maps.googleapis.com/maps/api/place/search/json?location=%f,%f&radius=%f&types=%@&sensor=true&key=%@",
                                    centerLat, centerLng, dist, types, kGOOGLE_API_KEY];
